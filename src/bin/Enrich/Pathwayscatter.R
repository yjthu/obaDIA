...
p<-p+ggtitle("Statistics of KEGG Pathway Enrichment") + ylab("Rich factor") +xlab("KEGG term")
...
p
ggsave(paste(args[3],".scatterplot.png",sep=""), plot=p,type="cairo-png", width=8, height=6, dpi=700)
ggsave(paste(args[3],".scatterplot.pdf",sep=""), plot=p, width=8, height=6)
